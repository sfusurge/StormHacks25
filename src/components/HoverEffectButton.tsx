...
const HoverEffectButton = ({
    ...
    return (
        <button
            className={`cursor-pointer group relative transition-all duration-300 border-[0.643px] border-hover-button hover:border-main hover:shadow-[0_0_7px_0_var(--color-hover-button)] ${className}`}
            onMouseEnter={() => play()}
            onClick={onClick}
        >
