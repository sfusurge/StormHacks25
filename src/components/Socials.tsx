    ...
    return (
        <div>
            <div className="flex flex-row justify-center items-center gap-4 mt-4">
                <Link href="https://www.instagram.com/stormhacks/" target="_blank" rel="noopener noreferrer">
                ...
                <Link href="https://www.linkedin.com/company/stormhacks/" target="_blank" rel="noopener noreferrer">
