    ...
    return (
        <div className="mt-auto mb-8 relative border border-[#574E49] bg-[#161414D9] w-[181px] h-[43px]">
            <div className="flex justify-between items-center h-full">
                ...
                <div className="flex justify-center items-center w-[153px] gap-2 h-[33px] p-[6.427px] flex-shrink-0 border-[0.643px] border-[#372F2F] bg-[#06060599]">
                    <div className="flex flex-row gap-0 items-center">
                        <Image src="/assets/clock.svg" height={15} width={16} alt="clock"/>
                        {isEditing ? (
                            <input
                                ref={inputRef}
                                className="text-[#8A6F6A] w-[48px] text-center text-xs bg-transparent outline-none"
                                value={inputValue}
